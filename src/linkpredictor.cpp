...
void linkpredictor(string queryActor, const char* inFilename,
    ...
    vector<string> v1 = graph.partialBFS(queryActor, 1);
    vector<string> v2 = graph.partialBFS(queryActor, 2);
    ...
    priority_queue<pair<int, string>, vector<pair<int, string>>, Alpha> pq1 =
        priority_queue<pair<int, string>, vector<pair<int, string>>, Alpha>();
    priority_queue<pair<int, string>, vector<pair<int, string>>, Alpha> pq2 =
        priority_queue<pair<int, string>, vector<pair<int, string>>, Alpha>();
...
int main(int argc, char* argv[]) {
    ...
    while (pfile) {
        ...
        /*now call LINK PREDICTOR on that pair*/
        linkpredictor(record[0], inFilename, firstoutFile, secondoutFile);
    }
